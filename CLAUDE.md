...
### Последний сеанс
- Добавлена автогенерация CLAUDE.md при создании проекта со всеми инструкциями
- Включены: git-workflow, именование файлов, формат CURRENT_STAGES.md, настройки GitHub, снапшот состояния
- GitHub username/email автоподставляются из глобальных настроек Projects Manager
