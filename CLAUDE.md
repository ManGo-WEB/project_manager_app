...
### Последний сеанс
- Добавлен баг-трекер `docs/BUGS.md` с инструкцией и автогенерацией при создании проекта
- Завершённые этапы на странице проекта теперь схлопываются (раскрытие по клику)
- Исправлен перенос бейджа статуса «В работе» на две строки (BUG-3)
- Исправлен счётчик заметок — отображается сразу при загрузке страницы (BUG-2)

### Следующие шаги
- Устранение выявленных багов и улучшение UX
- Приступить к Этапу 9 (дедлайны и сроки)
