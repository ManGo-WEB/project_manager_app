...
### Последний сеанс
- Реализован Этап 10: экспорт отчёта
  - API: GET /api/projects/[slug]/export — генерация сводного Markdown-отчёта
  - Кнопка «Экспорт» на странице проекта с модалкой выбора формата
  - Скачивание Markdown-файла напрямую
  - Генерация PDF через html2pdf.js (скачивание файла, без окна печати)
  - Дата в имени файла: `project-report-YYYY-MM-DD.md/.pdf`

### Следующие шаги
- Приступить к Этапу 11 (статистика и аналитика)
